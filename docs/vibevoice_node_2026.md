...
RTX 5090 Laptop, 1.5B, compute `bf16`: RTF 0.259 — генерация быстрее
реального времени. На `f32` — 1.68 (в бэкенде нет fused-GEMM для f32), так
что для работы имеет смысл держать `bf16`.
