...
const ALLOWED: &[(&str, &str)] = &[
    ...
    // Русские синонимы дней у повтора событий (`only_days`/`skip_days`):
    // разбор того, что прислала модель, а не текст для неё.
    ("src/agent/tools/notes/calendar.rs", "\"будни\""),
    ("src/agent/tools/notes/calendar.rs", "\"выходные\""),
