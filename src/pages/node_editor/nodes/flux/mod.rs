...
/// MXFP8: 12 ГБ резидентно и почти без потери качества; NVFP4 — 6 ГБ;
/// плотный BF16 (23 ГБ) на 24-гигабайтной карте рядом с рабочим столом не
/// помещается целиком и стримит блоки с хоста.
pub const DEFAULT_QUANT_IDX: usize = 1;
/// Где держать плотные веса (на квант не влияет — он всегда резидентен).
